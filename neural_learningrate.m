   ...
   % teacher_1 = dot(teacher_w1, dataset);
    ...
    for j = 1:K
       ...
       %student_weights(j,:) =  student_weights(j,:) - ((learning_rate/samples)* gradeint_epsilon_studentweights');
        student_weights(j,:) =  student_weights(j,:) - ((Learningrates_array(learning)/samples)* gradeint_epsilon_studentweights');
...
legend('Learning rate optimization0','Learning rate optimization1','Learning rate optimization1.5','Learning rate optimization10')
hold on
end
